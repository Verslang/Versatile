...
echo "====================================================="
echo "  Versatile Project - macOS Build Script"
...
if ! command -v verslang &> /dev/null; then
    ...
    echo ""
    echo "If you have Homebrew, you can install with:"
    echo "  brew install verslang"
    echo ""
    echo "Or build from the installer source:"
    echo "  installer/verslang-installer/installer-macos.vlang"
    exit 1
fi
...
echo "  Linking libversnative.dylib..."
verslang -link -shared build/output/string_ops.o build/output/math_engine.o build/output/memory_pool.o build/output/json_parser.o build/output/hash_table.o -o build/output/libversnative.dylib
...
echo "  Compiling installer-macos.vlang..."
verslang installer/verslang-installer/installer-macos.vlang -o build/output/installer-macos.o -f obj

echo "  Linking verslang-installer..."
verslang -link build/output/installer-common.o build/output/installer-macos.o -o build/output/verslang-installer -f elf64
...
echo "    - libversnative.dylib    (Native module library)"
